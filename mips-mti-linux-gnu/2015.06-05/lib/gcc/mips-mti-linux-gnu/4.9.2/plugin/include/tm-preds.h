/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/user/mipsswt/git/gcc/gcc/config/mips/mips.md'.  */
...
extern int const_vector_same_uimm3_operand (rtx, enum machine_mode);
...
extern int const_vector_same_simm10_operand (rtx, enum machine_mode);
extern int const_vector_same_uimm4_operand (rtx, enum machine_mode);
...
extern int const_vector_same_simm5_operand (rtx, enum machine_mode);
...
extern int reg_or_vector_same_simm5_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_uimm5_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_uimm3_operand (rtx, enum machine_mode);
...
extern int reg_or_vector_same_uimm4_operand (rtx, enum machine_mode);
...
extern int reg_or_vector_same_uimm8_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_byte_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_bitumm3_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_bituimm4_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_bituimm5_operand (rtx, enum machine_mode);
extern int reg_or_vector_same_bituimm6_operand (rtx, enum machine_mode);
