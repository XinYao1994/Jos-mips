...
enum opt_code
{
  ...
  OPT_mbranch_cost_ = 1075,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1076,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1077,           /* -mcheck-zero-division */
  OPT_mclib_ = 1078,                         /* -mclib= */
  OPT_mcode_readable_ = 1079,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1080,             /* -mcompact-branches= */
  ...
  OPT_meva = 1093,                           /* -meva */
  OPT_mexplicit_relocs = 1094,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1095,                  /* -mextern-sdata */
  OPT_mfix_24k = 1096,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1097,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1098,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1099,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1100,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1101,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1102,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1103,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1104,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1105,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1106,                   /* -mflush-func= */
  OPT_mforbidden_slots = 1107,               /* -mforbidden-slots */
  OPT_mfp_exceptions = 1108,                 /* -mfp-exceptions */
  OPT_mfp32 = 1109,                          /* -mfp32 */
  OPT_mfp64 = 1110,                          /* -mfp64 */
  OPT_mfpxx = 1111,                          /* -mfpxx */
  OPT_mfused_madd = 1112,                    /* -mfused-madd */
  OPT_mglibc = 1113,                         /* -mglibc */
  OPT_mgp32 = 1114,                          /* -mgp32 */
  OPT_mgp64 = 1115,                          /* -mgp64 */
  OPT_mgpopt = 1116,                         /* -mgpopt */
  OPT_mhard_float = 1117,                    /* -mhard-float */
  OPT_mimadd = 1118,                         /* -mimadd */
  OPT_minterlink_compressed = 1119,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1120,              /* -minterlink-mips16 */
  OPT_mips = 1121,                           /* -mips */
  OPT_mips16 = 1122,                         /* -mips16 */
  OPT_mips3d = 1123,                         /* -mips3d */
  OPT_mllsc = 1124,                          /* -mllsc */
  OPT_mload_store_pairs = 1125,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1126,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1127,                    /* -mlong-calls */
  OPT_mlong32 = 1128,                        /* -mlong32 */
  OPT_mlong64 = 1129,                        /* -mlong64 */
  OPT_mlra = 1130,                           /* -mlra */
  OPT_mmad = 1131,                           /* -mmad */
  OPT_mmcount_ra_address = 1132,             /* -mmcount-ra-address */
  OPT_mmcu = 1133,                           /* -mmcu */
  OPT_mmemcpy = 1134,                        /* -mmemcpy */
  OPT_mmicromips = 1135,                     /* -mmicromips */
  OPT_mmsa = 1136,                           /* -mmsa */
  OPT_mmt = 1137,                            /* -mmt */
  OPT_mmxu = 1138,                           /* -mmxu */
  OPT_mnan_ = 1139,                          /* -mnan= */
  OPT_mno_float = 1140,                      /* -mno-float */
  OPT_mno_flush_func = 1141,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1142,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1143,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1144,                     /* -mno-mips3d */
  OPT_modd_spreg = 1145,                     /* -modd-spreg */
  OPT_mpaired_single = 1146,                 /* -mpaired-single */
  OPT_mplt = 1147,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1148,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1149,               /* -mrelax-pic-calls */
  OPT_msched_weight = 1150,                  /* -msched-weight */
  OPT_mshared = 1151,                        /* -mshared */
  OPT_msingle_float = 1152,                  /* -msingle-float */
  OPT_msmartmips = 1153,                     /* -msmartmips */
  OPT_msoft_float = 1154,                    /* -msoft-float */
  OPT_msplit_addresses = 1155,               /* -msplit-addresses */
  OPT_msym32 = 1156,                         /* -msym32 */
  OPT_msynci = 1157,                         /* -msynci */
  OPT_mtune_ = 1158,                         /* -mtune= */
  OPT_muclibc = 1159,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1160,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1161,                          /* -mvirt */
  OPT_mvr4130_align = 1162,                  /* -mvr4130-align */
  OPT_mxgot = 1163,                          /* -mxgot */
  OPT_mxpa = 1164,                           /* -mxpa */
  OPT_n = 1165,                              /* -n */
  OPT_no_canonical_prefixes = 1166,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1167,              /* -no-integrated-cpp */
  OPT_noasmopt = 1168,                       /* -noasmopt */
  OPT_nocpp = 1169,                          /* -nocpp */
  OPT_nodefaultlibs = 1170,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1171,                   /* -nostartfiles */
  OPT_nostdinc = 1172,                       /* -nostdinc */
  OPT_nostdinc__ = 1173,                     /* -nostdinc++ */
  OPT_nostdlib = 1174,                       /* -nostdlib */
  OPT_o = 1175,                              /* -o */
  OPT_p = 1176,                              /* -p */
  ...
  OPT_pie = 1181,                            /* -pie */
  OPT_pipe = 1182,                           /* -pipe */
  OPT_posix = 1183,                          /* -posix */
  OPT_print_file_name_ = 1184,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1185,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1186,          /* -print-multi-directory */
  OPT_print_multi_lib = 1187,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1188,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1189,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1190,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1191,               /* -print-prog-name= */
  OPT_print_search_dirs = 1192,              /* -print-search-dirs */
  OPT_print_sysroot = 1193,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1194,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1195,                        /* -profile */
  OPT_pthread = 1196,                        /* -pthread */
  OPT_quiet = 1197,                          /* -quiet */
  OPT_r = 1198,                              /* -r */
  OPT_rdynamic = 1199,                       /* -rdynamic */
  OPT_remap = 1200,                          /* -remap */
  OPT_s = 1201,                              /* -s */
  OPT_s_bc_abi = 1202,                       /* -s-bc-abi */
  OPT_save_temps = 1203,                     /* -save-temps */
  OPT_save_temps_ = 1204,                    /* -save-temps= */
  OPT_shared = 1205,                         /* -shared */
  OPT_shared_libgcc = 1206,                  /* -shared-libgcc */
  /* OPT_specs = 1207, */                    /* -specs */
  OPT_specs_ = 1208,                         /* -specs= */
  OPT_static = 1209,                         /* -static */
  OPT_static_libasan = 1210,                 /* -static-libasan */
  OPT_static_libgcc = 1211,                  /* -static-libgcc */
  OPT_static_libgcj = 1212,                  /* -static-libgcj */
  OPT_static_libgfortran = 1213,             /* -static-libgfortran */
  OPT_static_libgo = 1214,                   /* -static-libgo */
  OPT_static_liblsan = 1215,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1216,               /* -static-libstdc++ */
  OPT_static_libtsan = 1217,                 /* -static-libtsan */
  OPT_static_libubsan = 1218,                /* -static-libubsan */
  /* OPT_std_c__03 = 1219, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1220, */                /* -std=c++0x */
  OPT_std_c__11 = 1221,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1222, */                /* -std=c++14 */
  ...
  OPT_time = 1256,                           /* -time */
  OPT_time_ = 1257,                          /* -time= */
  OPT_tno_android_cc = 1258,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1259,                 /* -tno-android-ld */
